...
function Addproj4() {
  return (
    <div className='h-[956px] w-full  bg-white justify-start items-start inline-flex'>
      {/**heading */}
      <div className='h-[957px] w-full  pb-8 bg-white flex-col justify-start items-start inline-flex'>
        ...
        {/**steps */}
        <div className='w-full  h-[855px] px-8 flex-col justify-start items-start gap-6 flex'>
          ...
          <div className='w-full self-stretch h-[707px] flex-col justify-start items-center gap-6 flex'>
            ...
            <div className='w-[456px] px-7 py-8 bg-white rounded-[10px] border border-[#d0d4dd] justify-start items-start gap-2 inline-flex'>
              <div className='w-full flex-col justify-start items-center gap-8 inline-flex'>
                ...
                <div className='w-full self-stretch h-[508px] flex-col justify-center items-end gap-8 flex'>
                  ...
                  <div className='w-full flex-col justify-start items-start gap-6 flex'>
                    <div className='w-full h-[116px] flex-col justify-start items-start gap-2 flex'>
                      <div className='self-stretch h-[116px] flex-col justify-start items-start gap-1 flex'>
                        <div className="self-stretch text-[#101828] text-sm font-medium font-['Urbanist'] leading-tight">
                          Brief Description
                        </div>
                        <div className='w-full self-stretch h-[92px] p-4 bg-white rounded-md border border-[#d0d5dd]/60 justify-start items-start gap-3 inline-flex'>
                          <div className='w-full grow shrink basis-0 h-5 justify-start items-center gap-2 flex'>
                            <div className='justify-start items-center gap-0.5 flex'>
                              <div className="text-[#98a1b2] text-sm font-normal font-['Urbanist'] leading-tight">
                  ...
                  <div className='w-full h-[49px] px-6 py-4 rounded-lg border border-indigo-600 flex-col justify-center items-center gap-2.5 flex'>
