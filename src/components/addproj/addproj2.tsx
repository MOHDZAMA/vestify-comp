...
function Addproj2() {
  return (
    <div className='h-[1089px] w-full bg-white justify-start items-start inline-flex'>
      <div className='h-[1089px] w-full pb-8 bg-white flex-col justify-start items-start inline-flex'>
        {/**heading */}
        ...
        <div className='w-full h-[987px] px-8 flex-col justify-start items-start gap-6 flex'>
          ...
          <div className='self-stretch h-[910px] flex-col justify-start items-center gap-6 flex'>
            ...
            <div className=' w-[456px] px-7 py-8 bg-white rounded-[10px] border border-[#d0d4dd] justify-start items-start gap-2 inline-flex'>
              <div className=' w-full flex-col justify-start items-center gap-8 inline-flex'>
                ...
                <div className='w-full self-stretch h-[711px] flex-col justify-start items-center gap-8 flex'>
